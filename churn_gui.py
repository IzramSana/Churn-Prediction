...
if uploaded_file:
    try:
        ...
        # Visualizations with reduced size
        ...
        # 1. Pie chart for Churned vs Retained (reduced size)
        with col1:
        ...
        # 2. Pie chart for Device Protection (reduced size)
        with col2:
        ...
        # 3. Bar graph for Tech Support (reduced size)
        ...
        # 4. Bar graph for Streaming TV (reduced size)
        with col4:
        ...
        # 5. Scatter plot for Tenure vs Churn Probability (replaced Streaming Movies)
        ...
        # 6. Bar graph for Contract (reduced size)
        with col6:
        ...
        # 7. Scatter plot for Monthly Charges (reduced size)
        ...
        # 8. Scatter plot for Total Charges (reduced size)
        with col8:
        ...
        # 9. Top 10 Risk Points
        st.subheader("🚨 Top 10 High-Risk Customers")
        
        # Get top 10 customers with highest churn probability
        top_risk_customers = original_input.nlargest(10, 'Churn_Probability')
        
        # Display in a nice format with rupees
        ...
        # Feature Importance (reduced size)
